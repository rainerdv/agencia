...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <a href="crear.php"  class="btn btn-primary mt-4">Crear viajero</a>
      <a href="viajes_realizados.php"  class="btn btn-primary mt-4">Registro de viajes</a>
      <hr>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2 class="mt-3">Lista de Viajeros</h2>
      <table class="table">
        <thead>
          <tr>
            <th>id</th>
